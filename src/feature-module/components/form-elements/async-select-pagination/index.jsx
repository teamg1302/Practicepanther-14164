/**
 * Async Select with Pagination component for React Hook Form.
 * Supports search, infinite scroll, and load more functionality.
 * @module feature-module/components/form-elements/async-select-pagination
 */
...
/**
 * Async Select with Pagination component props.
 * @typedef {Object} AsyncSelectPaginationProps
...
/**
 * Async Select with Pagination component that fetches options dynamically.
 * Supports search and infinite scroll pagination.
 *
 * @param {AsyncSelectPaginationProps} props - Component props
 * @returns {JSX.Element} Async Select component with pagination
 *
 * @example
      ...
      <Controller
        ...
        render={({ field }) => (
          <AsyncSelect
            ...
            onChange={(selected) => {
              if (selected) {
                // Store selected option in cache to preserve label
                selectedOptionsCache.current[selected.value] = selected;
              }
            ...
            value={
              field.value
                ? allOptions.find((option) => option.value === field.value) ||
                  selectedOptionsCache.current[field.value] || {
...
AsyncSelectPagination.propTypes = {
